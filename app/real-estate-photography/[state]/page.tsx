...
export async function generateStaticParams() {
  try {
    ...
    // Database not set up - return placeholder states
    return [
      { state: 'nsw' },
      { state: 'vic' },
      { state: 'qld' },
...
export async function generateMetadata({
  ...
  return {
    title: `Real Estate Photography ${state.name} | Property Photos ${state.code} | Australian Property Marketing`,
    description: `Professional real estate photography across ${state.name}. From $295 with 24-hour delivery. Trusted by local agents. Book online today.`,
    openGraph: {
      title: `Real Estate Photography ${state.name} | Australian Property Marketing`,
      description: `Professional property photography in ${state.name}. From $295. 24-hour delivery.`,
      type: 'website',
      locale: 'en_AU',
    },
  };
...
export default async function StatePhotographyPage({
  params,
}: {
  params: Promise<{ state: string }>;
}) {
  ...
  try {
    ...
    // Fetch all suburbs in this state
    ...
    suburbs = stateSlug === 'nsw' ? [
      { id: 1, name: 'Bondi', slug: 'bondi', stateSlug: 'nsw', city: 'Sydney', basePrice: 350, priority: 10, medianPriceFormatted: '2,850,000' },
      { id: 2, name: 'Paddington', slug: 'paddington', stateSlug: 'nsw', city: 'Sydney', basePrice: 350, priority: 9, medianPriceFormatted: '2,450,000' },
      { id: 3, name: 'Surry Hills', slug: 'surry-hills', stateSlug: 'nsw', city: 'Sydney', basePrice: 320, priority: 10, medianPriceFormatted: '1,650,000' },
    ] : [];
  }
    ...
    <>
      ...
      <section className="relative h-[500px] bg-gradient-to-br from-navy-900 to-slate-800">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
          <h1 className="text-5xl md:text-6xl font-black text-white mb-4">
            Real Estate Photography in {state.name}
          </h1>
          <p className="text-xl text-white/90 mb-8 max-w-2xl">
            Professional property photography across {state.name}. From $295 with 24-hour delivery. Serving {suburbs.length} locations statewide.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 bg-soft-grey rounded-xl">
              ...
              <div className="text-sm text-slate-600">Photo Delivery</div>
            </div>
            <div className="text-center p-6 bg-soft-grey rounded-xl">
            ...
            <div className="text-center p-6 bg-soft-grey rounded-xl">
              ...
              <div className="text-sm text-slate-600">Happy Agents</div>
            </div>
          </div>
        </div>
      </section>
              ...
              {featuredSuburbs.map((suburb) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {suburb.medianPriceFormatted && (
                      <span className="text-xs text-slate-500">
                        Median: ${suburb.medianPriceFormatted}
                      </span>
                    )}
                  </div>
                </Link>
      ...
      <section className="py-20 px-6 bg-soft-grey">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-black mb-8 text-center">Our Services in {state.name}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Professional Photography</h3>
                  <p className="text-slate-600 text-sm">
                    High-quality property photos with professional editing and 24-hour delivery.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Property Video</h3>
                  <p className="text-slate-600 text-sm">
                    Cinematic property videos that engage buyers and increase enquiries.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Drone Photography</h3>
                  <p className="text-slate-600 text-sm">
                    CASA-certified aerial photography to showcase location and property features.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Virtual Staging</h3>
                  <p className="text-slate-600 text-sm">
                    Digital furniture staging from $48/room to help buyers visualize the space.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-6 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Professional property photography from $295. 24-hour delivery. Same-day availability in most locations.
          </p>
