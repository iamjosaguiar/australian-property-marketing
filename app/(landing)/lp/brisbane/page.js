...
export default function BrisbaneLP() {
  return (
    <div className={styles.landing}>
      <JsonLd data={localBusinessSchema({ city: 'Brisbane', description: 'Brisbane real estate marketing that generates listings, not just leads. The Profitability Audit traces every dollar through your pipeline.' })} />
