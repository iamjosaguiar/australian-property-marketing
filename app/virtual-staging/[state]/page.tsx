...
export async function generateMetadata({
  ...
  return {
    title: `Virtual Staging ${state.name} | Digital Furniture Staging ${state.code} | Australian Property Marketing`,
    description: `Professional virtual staging across ${state.name}. From $48 per room with 24-hour delivery. Transform vacant properties. Book online today.`,
    openGraph: {
      title: `Virtual Staging ${state.name} | Australian Property Marketing`,
      description: `Virtual furniture staging in ${state.name}. From $48 per room. 24-hour delivery.`,
      type: 'website',
      locale: 'en_AU',
    },
  };
...
export default async function StateVirtualStagingPage({
  params,
}: {
  params: Promise<{ state: string }>;
}) {
  ...
  try {
    ...
    suburbs = stateSlug === 'nsw' ? [
      { id: 1, name: 'Bondi', slug: 'bondi', stateSlug: 'nsw', city: 'Sydney', stagingPrice: 48, priority: 10 },
      { id: 2, name: 'Paddington', slug: 'paddington', stateSlug: 'nsw', city: 'Sydney', stagingPrice: 48, priority: 9 },
      { id: 3, name: 'Surry Hills', slug: 'surry-hills', stateSlug: 'nsw', city: 'Sydney', stagingPrice: 48, priority: 10 },
    ] : [];
  }
        ...
        <section className="relative h-[500px] bg-gradient-to-br from-navy-900 to-slate-800">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
            <h1 className="text-5xl md:text-6xl font-black text-white mb-4">
              Virtual Staging in {state.name}
            </h1>
            <p className="text-xl text-white/90 mb-8 max-w-2xl">
              Professional virtual staging across {state.name}. From $48 per room with 24-hour delivery. Serving {suburbs.length} locations statewide.
            </p>
                    ...
                    {(citySuburbs as any[]).map((suburb) => (
                      ...
                      >
                        ...
                        <div className="text-sm text-slate-500">
                          From ${suburb.stagingPrice || 48}/room
                        </div>
                      </Link>
                    ))}
                  </div>
        ...
        <section className="py-20 px-6 bg-primary text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Professional virtual staging from $48 per room. 24-hour delivery. Same-day availability in most locations.
            </p>
